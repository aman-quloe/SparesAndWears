...
const AutomotiveLcv = () => {
  ...
  const fetchHandler = async () => {
    await axios
      .get('https://www.sparesandwears.com/AndroidCon/automotive_lcv.php')
      .then(response => {
...
//               flexDirection: 'row',
//             }}>
//             <TextInput placeholder="Search" style={{width: '80%',padding:3}}></TextInput>
//             <View
//               style={{
//                 backgroundColor: '#c4171d',
//                 justifyContent: 'center',
