...
const SportsCategory = ({navigation}) => {
            ...
            <View>
              <View>
                ...
                <View
                  ...
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => navigation.navigate('SportYoga')}>
                  ...
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => navigation.navigate('SportDoor')}>
                    <View style={styles.shadowboxlarge}>
                      <Image
                        source={{
                ...
                <View
                  ...
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => navigation.navigate('SportGym')}>
                    <View style={styles.shadowboxlarge}>
                      <Image
                        source={{
                  ...
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => navigation.navigate('SportColored')}>
                    <View style={styles.shadowboxlarge}>
                      <Image
                        // source={{
